'  NOTE: Can just READ the ini file. CANNOT write. ~nash
...
Namespace Config
    ...
    Public Class IniFile
        ...
        ''' </summary>
        ''' <param name="IniSection">Ini Section. The word contain in braket is the section (e.g [word])</param>
        ''' <param name="IniKey">Ini Key</param>
        ''' <param name="IniFullPath">Ini fullpath including filename</param>
        Public Shared Function ReadIni(IniSection As String, IniKey As String, IniFullPath As String) As String

            '====== Example INI ==================================================
            '[Path]                     <----------- This is the Section
            'Source=D:\test\            <----------- This is the Key and the Value
            '====== Example INI ==================================================

            Dim MyIni As New IniFile
            MyIni.Load(IniFullPath)

            Return MyIni.GetKeyValue(IniSection, IniKey)
        End Function
