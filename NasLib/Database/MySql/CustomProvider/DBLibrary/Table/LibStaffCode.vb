...
Namespace Database.MySql.CustomProvider.DBLibrary.Table
    ...
    ''' <summary>
    ''' This is a table base class base on table 'lib_staffcode'. This table only consisted of mandatory Library Staff
    ''' </summary>
    Public Class LibStaffCode
