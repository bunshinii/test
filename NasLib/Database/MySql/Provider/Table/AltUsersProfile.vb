...
Namespace Database.MySql.Provider.Table
    ...
    ''' <summary>
    ''' This is a table base class base on table 'alt_members_profile'
    ''' </summary>
    Public Class AltUsersProfile
...
#Region "MySql Table Setting"
        ...
        Private Shared Function TableName() As String
            Return "alt_members_profile"            '<-------------------------------------- 1 ' Modify TableName
        End Function
        ...
        Private Enum eFieldName
            ...
            kku_approval_by         'kkuuitm reserved
            kku_approval_date       'kkuuitm reserved
...
#Region "kku_approval_by"
        ...
        Public Shared Property KkuApprovalBy(ByVal UserId As Integer, ProviderConnectionString As String) As String
            Get
                Dim MyFieldName As String = FieldName(eFieldName.kku_approval_by)
                Dim MyCriteria As String = Criteria(FieldName(eFieldName.id), UserId)
...
#Region "kku_approval_date"
        ...
        Public Shared Property KkuApprovalDate(ByVal UserId As Integer, ProviderConnectionString As String) As String
            Get
                Dim MyFieldName As String = FieldName(eFieldName.kku_approval_date)
                Dim MyCriteria As String = Criteria(FieldName(eFieldName.id), UserId)
...
#Region "Regular Functions"
        ...
        Public Shared Function Count(Keyword As String, ProviderConnectionString As String) As Integer
            Dim MyCriterias As String = CriteriasOR(Criteria(eFieldName.id.ToString, Keyword), Criteria(eFieldName.id.ToString, Keyword), CriteriaLike(eFieldName.full_name.ToString, String.Format("%{0}%", Keyword)))
