...
#Region "Command Select"
        ...
        Public Function CmdSelect(ByVal TableName As String, ByVal Fields As String, ByVal ReturnColumn As Integer, Optional ByVal Criteria As String = "", Optional ByVal OtherSet As String = "") As String
        ...
        ''' </summary>
        Public Function CmdSelect0(ByVal TableName As String, ByVal Fields As String, ByVal ReturnColumn As Integer, Optional ByVal Criteria As String = "", Optional ByVal OtherSet As String = "") As String
        ...
        ''' </summary>
        Public Function CmdSelectBool(ByVal TableName As String, ByVal Fields As String, ByVal ReturnColumn As Integer, Optional ByVal Criteria As String = "", Optional ByVal OtherSet As String = "") As String
        ...
        ''' </summary>
        Public Function CmdSelect2(ByVal TableName As String, ByVal Fields As String, ByVal ReturnColumn As Integer, Optional ByVal Criteria As String = "", Optional ByVal OtherSet As String = "") As String
        ...
        Public Function CmdSelectLimit(ByVal TableName As String, ByVal Fields As String, Optional ByVal Criteria As String = "", Optional ByVal OtherSet As String = "") As String
        ...
        ''' </summary>
        Public Function CmdSelectId(ByVal TableName As String, Optional ByVal Criteria As String = "") As String
        ...
        ''' </summary>
        Public Function CmdQuerySelect(ByVal TableName As String, ByVal Fields As String, ByVal ReturnColumn As Integer, Optional ByVal Criteria As String = "", Optional ByVal OtherSet As String = "") As String
        ...
        ''' <param name="Criteria">WHERE Clause. e.g. "Field1 = 1". *You dont have to wrap in quotes if the value is number for MsAccess</param>
        ''' <param name="OtherSet">Can use "ORDER BY or LIMIT"</param>
        Public Function CmdSelectUnion(ByVal TableNames As String, ByVal Fields As String, ByVal ReturnColumn As Integer, Optional ByVal Criteria As String = "", Optional ByVal OtherSet As String = "") As String
        ...
        ''' <param name="Criteria">WHERE Clause. e.g. "Field1 = 1". *You dont have to wrap in quotes if the value is number for MsAccess</param>
        Public Function CmdSelectBlob(ByVal TableName As String, ByVal FieldName As String, ByVal ReturnColumn As Integer, Optional ByVal Criteria As String = "", Optional ByVal OtherSet As String = "") As String
        ...
        ''' <param name="ReturnColumn">Return a field data specified by column index (Just enter '0')</param>
        ''' <param name="Criteria">WHERE Clause. e.g. "Field1 = 1". *You dont have to wrap in quotes if the value is number for MsAccess</param>
        Public Function CmdSelectBlobSize(ByVal TableName As String, ByVal FieldName As String, ByVal ReturnColumn As Integer, Optional ByVal Criteria As String = "", Optional ByVal OtherSet As String = "") As String
        ...
        Public Function CmdCount(ByVal TableName As String, Optional ByVal Criteria As String = "") As String
        ...
        Public Function CmdSum(ByVal TableName As String, FieldName As String, Optional ByVal Criteria As String = "") As String
        ...
        ''' </summary>
        Public Function CmdMin(ByVal TableName As String, FieldName As String, Optional ByVal Criteria As String = "") As String
        ...
        ''' </summary>
        Public Function CmdMax(ByVal TableName As String, FieldName As String, Optional ByVal Criteria As String = "") As String
...
#Region "Command Insert"
        ...
        Public Function CmdInsert(ByVal TableName As String, ByVal FieldsName As String, ByVal FieldsValue As String) As String
            Dim ReturnValue As String = Nothing

            Dim SqlCommand As String = String.Format("INSERT INTO {0} ({1}) VALUES ({2});", TableName, FieldsName, FieldsValue)
            ReturnValue = SqlCommand

            ReturnValue = ReturnValue & "SELECT LAST_INSERT_ID();"
            Return ReturnValue
        ...
        ''' </summary>
        Public Function CmdInsert2(ByVal TableName As String, ByVal FieldsName As String, ByVal FieldsValue As String) As String
        ...
        Public Function CmdInsertString(ByVal TableName As String, ByVal FieldsName As String, ByVal FieldsValue As String) As String
        ...
        Public Function CmdInsertInt(ByVal TableName As String, ByVal FieldsName As String, ByVal FieldsValue As String) As String
        ...
        Public Function CmdInsertBlob(ByVal TableName As String, ByVal FieldsName As String, ByVal FieldsValue As Byte()) As String

            Dim SqlCommand As String = String.Format("INSERT INTO {0} ({1}) VALUES (@Param1);", TableName, FieldsName)
            Return SqlCommand & " SELECT LAST_INSERT_ID();"
        End Function
...
#Region "Command Update"
        ...
        ''' </summary>
        Public Function CmdUpdate(ByVal TableName As String, ByVal FieldName As String, ByVal FieldValue As String, Optional ByVal Criteria As String = "") As String
        ...
        ''' </summary>
        Public Function CmdUpdate2(ByVal TableName As String, ByVal FieldsName As String, ByVal FieldsValue As String, Optional ByVal Criteria As String = "") As String
        ...
        Public Function CmdUpdate3(ByVal TableName As String, ByVal FieldName As String, ByVal FieldValue As String, Optional ByVal Criteria As String = "") As String
        ...
        ''' </summary>
        Public Function CmdUpdateDate(ByVal TableName As String, ByVal FieldName As String, ByVal FieldValue As String, Optional ByVal Criteria As String = "") As String
        ...
        ''' </summary>
        Public Function CmdUpdateDateTime(ByVal TableName As String, ByVal FieldName As String, ByVal FieldValue As String, Optional ByVal Criteria As String = "") As String
        ...
        ''' </summary>
        Public Function CmdUpdateBlob(ByVal TableName As String, ByVal FieldName As String, ByVal FieldValue As Byte(), Optional ByVal Criteria As String = "") As String
...
#Region "Command Delete"
        ...
        Public Function CmdDelete(ByVal TableName As String, Optional ByVal Criteria As String = "") As String
...
#Region "Commad Select Table"
        ...
        ''' <summary>
        ''' Select a table (Web Application). ColumnName is automatically included.
        ''' </summary>
        ...
        Public Function CmdSelectTable(ByVal TableName As String, Optional ByVal Fields As String = "*", Optional ByVal Criteria As String = "", Optional ByVal OtherSet As String = "") As String
            If Criteria.Length > 0 Then
                Criteria = " WHERE " & Criteria
            End If
        ...
        Public Function CmdSelectGroup(ByVal TableName As String, ByVal Field As String, Optional ByVal Criteria As String = "", Optional ByVal OtherSet As String = "") As String
            If Criteria.Length > 0 Then
                Criteria = " WHERE " & Criteria
            End If
        ...
        Public Function CmdSelectGroup(ByVal TableName As String, ByVal Fields As String, ByVal GroupByField As String, Optional ByVal Criteria As String = "", Optional ByVal OtherSet As String = "") As String
            If Criteria.Length > 0 Then
                Criteria = " WHERE " & Criteria
            End If
...
#Region "Checks"
        ...
        ''' </summary>
        Public Function IsTableExisted(TableName As String, DatabaseName As String) As String
...
#Region "Command Copy / Move Tables Row / Column"
        ...
        ''' <param name="Criteria">WHERE Clause. e.g. "Field1 = 1". *You dont have to wrap in quotes if the value is number for MsAccess</param>
        ''' <param name="OtherSet">Can use "ORDER BY or LIMIT"</param>
        Public Function CmdCopyColumn(DestTableName As String, DestFieldName As String, SourceTableName As String, SourceFieldName As String, Optional ByVal Criteria As String = "", Optional ByVal OtherSet As String = "") As String
            If Criteria.Length > 0 Then
                Criteria = " WHERE " & Criteria
            End If
...
#Region "Command Save into Files"
        ...
        ''' <param name="Criteria">WHERE Clause. e.g. "Field1 = 1". *You dont have to wrap in quotes if the value is number for MsAccess</param>
        ''' <param name="OtherSet">Can use "ORDER BY or LIMIT"</param>
        Public Function CmdSaveBlob(SavePath As String, TableName As String, BlobFieldName As String, Optional ByVal Criteria As String = "", Optional ByVal OtherSet As String = "") As String
            If Criteria.Length > 0 Then
                Criteria = " WHERE " & Criteria
            End If
        ...
        ''' <param name="Criteria">WHERE Clause. e.g. "Field1 = 1". *You dont have to wrap in quotes if the value is number for MsAccess</param>
        ''' <param name="OtherSet">Can use "ORDER BY or LIMIT"</param>
        Public Function CmdSaveToText(SavePath As String, TableName As String, FieldNames As String, Optional ByVal Criteria As String = "", Optional ByVal OtherSet As String = "", Optional FieldsTerminatedBy As String = ":", Optional LinesTerminatedBy As String = "\n") As String
            If Criteria.Length > 0 Then
                Criteria = " WHERE " & Criteria
            End If
