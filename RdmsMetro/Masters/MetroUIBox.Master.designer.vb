...
Partial Public Class MetroUIBox
    ...
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents Header As Global.Rdms_Metro.MyControls.MetroUI.Header
    ...
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents LeftCharm1 As Global.Rdms_Metro.MyControls.Rdms.LeftCharm.Container
    ...
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents Footer As Global.Rdms_Metro.MyControls.MetroUI.Footer
