...
#End Region
        ...
        Private Sub SaveData(IsFinish_ As Boolean, IsKiv_ As Boolean)
            ...
            MyModules.Database.RdmsQuestions.QuestionAdd(PatronId, mediumId, sub_od, sub_dc, sub_it, sub_op, sub_lrc, sub_rc, sub_fs, sub_vp, sub_ja, sub_gt, sub_etc, enq_qr, enq_rr, enq_st, enq_ag, enq_etc, question, answer, timeStart, timeEnd, isKiv, isFinished, OfficerId, BranchId, SatelliteId, DepartmentId, DivisionId, UnitId, StudentFacultyCode, StudentProgramCode, StudentCampusCode, StudentLevelCode, StudentModeCode, StaffDepartmentCode, StaffPositionCode, StaffTypeCode, SessionId)
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            Dim _PatronId As String = PatronId
