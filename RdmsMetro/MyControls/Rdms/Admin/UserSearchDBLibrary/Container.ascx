<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="Container.ascx.vb" Inherits="Rdms_Metro.MyControls.Rdms.Admin.UserSearchDBLibrary.Container" %>
...
<div style="width:90%; min-height:400px;">
    <asp:Panel ID="PanelMain" runat="server" DefaultButton="hiddenButton">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            ...
            <asp:LinkButton ID="lblManual" runat="server" CausesValidation="false">Manual Registration</asp:LinkButton>
    ...
    <asp:Panel ID="PanelLegend" runat="server" Visible="false">
        <label>Legend :</label>
        <div class="legend bg-darkGreen fg-white">
            Registered
        </div>
