<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="SatelliteEditor.ascx.vb" Inherits="Rdms_Metro.MyControls.Rdms.Announcement.SatelliteEditor" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
    ...
    <table>
        ...
        <asp:Panel ID="PanelDebug" runat="server" Visible="false">
            <asp:Label ID="gSatId" runat="server" Text="0"></asp:Label>
        </asp:Panel>
