...
Namespace MyControls.Rdms.Charts
    ...
    Public Class ByDayHourly
        Inherits System.Web.UI.UserControl

#Region "Message Daily Generator"

        Private Sub Message()
            If String.IsNullOrEmpty(MyRequest.GetDate) Then Exit Sub

            Dim MyDate As String = Format(CDate(MyRequest.GetDate), "dd MMMM yyyy")
...
#Region "Criterias Daily"
        ...
        Private Function MyCriteriaMediumHour(MediumId As Integer, Hour As Integer) As String
            Dim ReturnValue As String = CriteriasAND( _
                ...
                CriteriaDate(eFieldName.timeStart.ToString, TheDate), _
...
#Region "Load Table"
        ...
        Private Sub LoadVideoConferencing()
            Dim MediumId As Integer = 9 'Video Conferencing
            ...
            Dim MyChartSeriesOthers = Chart1.Series("VideoConferencing")
            MyChartSeriesOthers.Points.Item(0).SetValueY(CInt(lblVc00.Text))
            MyChartSeriesOthers.Points.Item(1).SetValueY(CInt(lblVc01.Text))
            MyChartSeriesOthers.Points.Item(2).SetValueY(CInt(lblVc02.Text))
            MyChartSeriesOthers.Points.Item(3).SetValueY(CInt(lblVc03.Text))
            MyChartSeriesOthers.Points.Item(4).SetValueY(CInt(lblVc04.Text))
            MyChartSeriesOthers.Points.Item(5).SetValueY(CInt(lblVc05.Text))
            MyChartSeriesOthers.Points.Item(6).SetValueY(CInt(lblVc06.Text))
            MyChartSeriesOthers.Points.Item(7).SetValueY(CInt(lblVc07.Text))
            MyChartSeriesOthers.Points.Item(8).SetValueY(CInt(lblVc08.Text))
            MyChartSeriesOthers.Points.Item(9).SetValueY(CInt(lblVc09.Text))
            MyChartSeriesOthers.Points.Item(10).SetValueY(CInt(lblVc10.Text))
            MyChartSeriesOthers.Points.Item(11).SetValueY(CInt(lblVc11.Text))
            MyChartSeriesOthers.Points.Item(12).SetValueY(CInt(lblVc12.Text))
            MyChartSeriesOthers.Points.Item(13).SetValueY(CInt(lblVc13.Text))
            MyChartSeriesOthers.Points.Item(14).SetValueY(CInt(lblVc14.Text))
            MyChartSeriesOthers.Points.Item(15).SetValueY(CInt(lblVc15.Text))
            MyChartSeriesOthers.Points.Item(16).SetValueY(CInt(lblVc16.Text))
            MyChartSeriesOthers.Points.Item(17).SetValueY(CInt(lblVc17.Text))
            MyChartSeriesOthers.Points.Item(18).SetValueY(CInt(lblVc18.Text))
            MyChartSeriesOthers.Points.Item(19).SetValueY(CInt(lblVc19.Text))
            MyChartSeriesOthers.Points.Item(20).SetValueY(CInt(lblVc20.Text))
            MyChartSeriesOthers.Points.Item(21).SetValueY(CInt(lblVc21.Text))
            MyChartSeriesOthers.Points.Item(22).SetValueY(CInt(lblVc22.Text))
            MyChartSeriesOthers.Points.Item(23).SetValueY(CInt(lblVc23.Text))
        End Sub
