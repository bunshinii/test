...
Namespace MyControls.Rdms.Charts
    ...
    Public Class ByMonthWeekly
        Inherits System.Web.UI.UserControl

#Region "Message Monthly Generator"

        Private Sub Message()
            If String.IsNullOrEmpty(MyRequest.GetDate) Then Exit Sub

            Dim MyDate As String = Format(CDate(MyRequest.GetDate), "MMMM yyyy")
...
#Region "Criterias Monthly Week"

        Private Function MyCriteriaMediumWeek(MediumId As Integer, WeekNoInMonth As Integer) As String
            Dim ReturnValue As String = CriteriasAND( _
                ...
                CriteriaWeek(eFieldName.timeStart.ToString, WeekNoInMonth))
            If CriteriaFromQueryString.Length > 0 Then ReturnValue = ReturnValue & " AND " & CriteriaFromQueryString()
            Return ReturnValue
        End Function

        Private Function MyCriteriaTotalWeek(WeekNoInMonth As Integer) As String
            Dim ReturnValue As String = CriteriasAND( _
                Criteria(FunctionYear(eFieldName.timeStart.ToString), Year(TheDate)), _
                Criteria(FunctionMonth(eFieldName.timeStart.ToString), Month(TheDate)), _
                Criteria(FunctionHour(eFieldName.timeStart.ToString), WeekNoInMonth))
...
#Region "Load Table"
        ...
        Private Sub LoadFaceToFace()
            ...
            lblFace01.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 1), MyAppConnectionString)
            lblFace02.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 2), MyAppConnectionString)
            lblFace03.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 3), MyAppConnectionString)
            lblFace04.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 4), MyAppConnectionString)
            lblFace05.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 5), MyAppConnectionString)
        ...
        Private Sub LoadLiveChat()
            ...
            lblChat01.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 1), MyAppConnectionString)
            lblChat02.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 2), MyAppConnectionString)
            lblChat03.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 3), MyAppConnectionString)
            lblChat04.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 4), MyAppConnectionString)
            lblChat05.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 5), MyAppConnectionString)
        ...
        Private Sub LoadPhone()
            ...
            lblPhone01.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 1), MyAppConnectionString)
            lblPhone02.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 2), MyAppConnectionString)
            lblPhone03.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 3), MyAppConnectionString)
            lblPhone04.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 4), MyAppConnectionString)
            lblPhone05.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 5), MyAppConnectionString)
        ...
        Private Sub LoadEmail()
            ...
            lblEmail01.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 1), MyAppConnectionString)
            lblEmail02.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 2), MyAppConnectionString)
            lblEmail03.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 3), MyAppConnectionString)
            lblEmail04.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 4), MyAppConnectionString)
            lblEmail05.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 5), MyAppConnectionString)
        ...
        Private Sub LoadSocialMedia()
            ...
            lblSocial01.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 1), MyAppConnectionString)
            lblSocial02.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 2), MyAppConnectionString)
            lblSocial03.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 3), MyAppConnectionString)
            lblSocial04.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 4), MyAppConnectionString)
            lblSocial05.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 5), MyAppConnectionString)
        ...
        Private Sub LoadInstantMessenger()
            ...
            lblInMessanger01.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 1), MyAppConnectionString)
            lblInMessanger02.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 2), MyAppConnectionString)
            lblInMessanger03.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 3), MyAppConnectionString)
            lblInMessanger04.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 4), MyAppConnectionString)
            lblInMessanger05.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 5), MyAppConnectionString)
        ...
        Private Sub LoadVideoConferencing()
            ...
            lblVc01.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 1), MyAppConnectionString)
            lblVc02.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 2), MyAppConnectionString)
            lblVc03.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 3), MyAppConnectionString)
            lblVc04.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 4), MyAppConnectionString)
            lblVc05.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 5), MyAppConnectionString)
        ...
        Private Sub LoadOthers()
            ...
            lblOther01.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 1), MyAppConnectionString)
            lblOther02.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 2), MyAppConnectionString)
            lblOther03.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 3), MyAppConnectionString)
            lblOther04.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 4), MyAppConnectionString)
            lblOther05.Text = MyCmd.CmdCount(TableName, MyCriteriaMediumWeek(MediumId, 5), MyAppConnectionString)
