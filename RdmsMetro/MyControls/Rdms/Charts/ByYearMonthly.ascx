<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ByYearMonthly.ascx.vb" Inherits="Rdms_Metro.MyControls.Rdms.Charts.ByYearMonthly" %>
    ...
    <asp:CHART id="Chart1" runat="server" Width="1000px" Height="600px" ClientIDMode="Static" >
        ...
        <chartareas>
            ...
            <asp:ChartArea Name="ChartArea1">
                ...
                <axisx Title="Month" Interval="1" IsLabelAutoFit="true"><MajorGrid LineColor="Gray" Interval="1" /></axisx>
            </asp:ChartArea>
        </chartareas>
