...
#Region "Functions"
        ...
        Private Sub DateValidationRules()
            'Must put on PageLoad

            'Range Validation Setting
            txtDateExt.StartDate = Now.AddYears(-10)
            txtDateExt.EndDate = Now
            txtDateVal.MinimumValue = Now.AddYears(-10).ToShortDateString
            txtDateVal.MaximumValue = Now.ToShortDateString
        End Sub
...
#Region "Fill Data"
        ...
        Private Sub FillData()
            ...
            txtDate.Text = Format(TheDate, "dd MMMM yyyy")
...
#Region "Generate Query Strings"
        ...
        Public Function GenerateQueryString() As String
            Dim ReturnValue As String = QueryString & GenerateStatsOptionQueryString()

            'Basic
            Dim MyDate As Date = Now
            If txtDate.Text.Length > 0 Then MyDate = txtDate.Text

            Dim MyKeys2() As String = {MyRequest._Year, MyRequest._Month, MyRequest._Day, MyRequest._ListingMode, MyRequest._FilterMode, MyRequest._FilterModeEnabled}
            Dim MyValues2() As String = {Year(MyDate), Month(MyDate), Day(MyDate), ddListType.SelectedIndex, ddFilter.SelectedIndex, chkType.Checked}
                        ...
                        Select Case ddFilter.SelectedValue
                            ...
                            Case "Student Faculty"
                                MyCriteria = CriteriasAND( _
                                    ...
                                    Criteria(FunctionDay("timeStart"), MyRequest.GetDay), _
...
#Region "Generate Message"
        ...
        Private Function GenerateMessage() As String
            ...
            Select Case ddListType.SelectedValue
                Case "Individual"
                    If Not String.IsNullOrEmpty(TheDate) Then ReturnValue = String.Format("Reference Desk sessions on {0} by {1}", Format(CDate(TheDate), "dd MMMM yyyy"), OfficerName)
                ...
                Case "Branch"
                    ...
                    If Not String.IsNullOrEmpty(TheDate) Then ReturnValue = String.Format("Reference Desk sessions on {0} in {1}", Format(CDate(TheDate), "dd MMMM yyyy"), ddBranch.SelectedItem.Text)
                ...
                Case "Satellite"
                    ...
                    If Not String.IsNullOrEmpty(TheDate) Then ReturnValue = String.Format("Reference Desk sessions on {0} in {1}", Format(CDate(TheDate), "dd MMMM yyyy"), ddSatellite.SelectedItem.Text)
                ...
                Case "Department"
                    ...
                    If Not String.IsNullOrEmpty(TheDate) Then ReturnValue = String.Format("Reference Desk sessions on {0} in {1}", Format(CDate(TheDate), "dd MMMM yyyy"), ddDepartment.SelectedItem.Text)
                ...
                Case "Division"
                    ...
                    If Not String.IsNullOrEmpty(TheDate) Then ReturnValue = String.Format("Reference Desk sessions on {0} in {1}", Format(CDate(TheDate), "dd MMMM yyyy"), ddDivision.SelectedItem.Text)
                ...
                Case "Unit"
                    ...
                    If Not String.IsNullOrEmpty(TheDate) Then ReturnValue = String.Format("Reference Desk sessions on {0} in {1}", Format(CDate(TheDate), "dd MMMM yyyy"), ddUnit.SelectedItem.Text)
...
#Region "Events"
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not IsPostBack Then
                LoadNonPostBackData()
                txtDate.Text = Format(Now, "dd MMMM yyyy")
