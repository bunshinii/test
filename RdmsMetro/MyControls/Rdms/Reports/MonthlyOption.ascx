<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="MonthlyOption.ascx.vb" Inherits="Rdms_Metro.MyControls.Rdms.Reports.MonthlyOption" %>
    ...
    <table class="bg-darkBlue fg-white" style="width:100%; table-layout:fixed;">
        ...
        <tr>
            <th colspan="2" class="padding">
                Select Month :
                <asp:DropDownList ID="ddMonth" runat="server"></asp:DropDownList> : <asp:DropDownList ID="ddYear" runat="server"></asp:DropDownList>
