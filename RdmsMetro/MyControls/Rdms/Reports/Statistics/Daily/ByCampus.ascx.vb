...
#Region "Criterias"
        ...
        Private Function MyCriteria(TheDate As Date) As String
            Dim ReturnValue As String = CriteriasAND( _
                ...
                CriteriaNot(eFieldName.studCampusCode.ToString, "0") _
                )
...
#End Region
        ...
        Private Sub LoadTable()
            Dim MyFields As String = FieldNames( _
                eFieldName.studCampusCode.ToString, _
                FunctionCount(eFieldName.id.ToString, "'total'") _
                )

            Dim MyOther As String = GroupBy(eFieldName.studCampusCode.ToString) & OrderBy("'total'", False)
        ...
        Private Sub GridView1_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles GridView1.RowDataBound
            If e.Row.RowType = DataControlRowType.DataRow Then
                ...
                Dim lblCode As Label = e.Row.FindControl("studCampusCode")

                'Patron Name
                Dim lblFullName As Label = e.Row.FindControl("fullname")
                lblFullName.Text = NasLib.Database.MySql.Provider.Table.StudCampus.CampusName(lblCode.Text, ProvidersConnectionString)
