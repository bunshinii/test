...
#Region "Criterias"
        ...
        Private Function MyCriteria(TheDate As Date) As String
            Dim ReturnValue As String = CriteriasAND( _
                ...
                CriteriaNot(eFieldName.divisionId.ToString, "0") _
                )
...
#End Region
        ...
        Private Sub LoadTable()
            ...
            Dim MyOther As String = GroupBy(eFieldName.divisionId.ToString) & OrderBy("'total'", False)
        ...
        Private Sub GridView1_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles GridView1.RowDataBound
            If e.Row.RowType = DataControlRowType.DataRow Then
                ...
                Dim lblCode As Label = e.Row.FindControl("divisionid")
                Dim MyId As Integer = lblCode.Text

                'Patron Name
                Dim lblFullName As Label = e.Row.FindControl("fullname")
                lblFullName.Text = NasLib.Database.MySql.Provider.Table.OfficeDivision.Division(MyId, ProvidersConnectionString)
