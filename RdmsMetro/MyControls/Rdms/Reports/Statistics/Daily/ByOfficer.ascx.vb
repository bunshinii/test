...
#End Region
        ...
        Private Sub LoadTable()
            ...
            Dim MyOther As String = GroupBy(eFieldName.officer.ToString) & OrderBy("'total'", False)
            ...
            If GridView1.Rows.Count > 0 Then
                ...
                GridView1.FooterRow.Cells(0).Attributes.Add("colspan", 3)
        ...
        Private Sub GridView1_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles GridView1.RowDataBound
            If e.Row.RowType = DataControlRowType.DataRow Then
                ...
                Dim lblId As Label = e.Row.FindControl("officer")

                'Patron Name
                Dim lblName As Label = e.Row.FindControl("fullname")
                lblName.Text = NasLib.Database.MySql.Provider.Table.UsersProfile.FullName(lblId.Text, ProvidersConnectionString)
            End If
        End Sub
