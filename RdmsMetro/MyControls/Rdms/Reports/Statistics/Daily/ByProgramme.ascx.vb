...
#Region "Criterias"
        ...
        Private Function MyCriteria(TheDate As Date) As String
            Dim ReturnValue As String = CriteriasAND( _
                ...
                CriteriaNot(eFieldName.studProgramCode.ToString, "0") _
                )
...
#End Region
        ...
        Private Sub LoadTable()
            Dim MyFields As String = FieldNames( _
                eFieldName.studProgramCode.ToString, _
                FunctionCount(eFieldName.id.ToString, "'total'") _
                )

            Dim MyOther As String = GroupBy(eFieldName.studProgramCode.ToString) & OrderBy("'total'", False)
        ...
        Private Sub GridView1_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles GridView1.RowDataBound
            If e.Row.RowType = DataControlRowType.DataRow Then
                ...
                Dim lblCode As Label = e.Row.FindControl("studProgramCode")

                'Patron Name
                Dim lblFullName As Label = e.Row.FindControl("fullname")
                lblFullName.Text = NasLib.Database.MySql.Provider.Table.StudProgram.ProgramDesc(lblCode.Text, ProvidersConnectionString)
