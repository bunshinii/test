...
#Region "Criterias"
        ...
        Private Function MyCriteria(TheDate As Date) As String
            Dim ReturnValue As String = CriteriasAND( _
                ...
                CriteriaNot(eFieldName.studModeCode.ToString, "0") _
                )
...
#End Region
        ...
        Private Sub LoadTable()
            Dim MyFields As String = FieldNames( _
                eFieldName.studModeCode.ToString, _
                FunctionCount(eFieldName.id.ToString, "'total'") _
                )

            Dim MyOther As String = GroupBy(eFieldName.studModeCode.ToString) & OrderBy("'total'", False)
        ...
        Private Sub GridView1_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles GridView1.RowDataBound
            If e.Row.RowType = DataControlRowType.DataRow Then
                ...
                Dim lblCode As Label = e.Row.FindControl("studModeCode")

                'Patron Name
                Dim lblFullName As Label = e.Row.FindControl("fullname")
                lblFullName.Text = NasLib.Database.MySql.Provider.Table.StudMode.ModDesc(lblCode.Text, ProvidersConnectionString)
