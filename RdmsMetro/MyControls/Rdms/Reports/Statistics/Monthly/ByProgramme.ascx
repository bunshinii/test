<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ByProgramme.ascx.vb" Inherits="Rdms_Metro.MyControls.Rdms.Reports.Statistics.Monthly.ByProgramme" %>
...
<asp:GridView ID="GridView1" runat="server" CssClass="table striped hovered" AutoGenerateColumns="false" Width="600px" ShowFooter="true" >
    <Columns>
            ...
            <asp:TemplateField HeaderText="Programme Code" SortExpression="studProgramCode" Visible="false">
                <ItemTemplate>
                    <asp:Label ID="studProgramCode" runat="server" Text='<%# Bind("studProgramCode")%>'></asp:Label>
                </ItemTemplate>
                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
