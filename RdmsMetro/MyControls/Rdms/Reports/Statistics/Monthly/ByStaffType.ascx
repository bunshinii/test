<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ByStaffType.ascx.vb" Inherits="Rdms_Metro.MyControls.Rdms.Reports.Statistics.Monthly.ByStaffType" %>
...
<asp:GridView ID="GridView1" runat="server" CssClass="table striped hovered" AutoGenerateColumns="false" Width="600px" ShowFooter="true" >
    <Columns>
            ...
            <asp:TemplateField HeaderText="Type Code" SortExpression="stafTypeCode" Visible="false">
                <ItemTemplate>
                    <asp:Label ID="stafTypeCode" runat="server" Text='<%# Bind("stafTypeCode")%>'></asp:Label>
                </ItemTemplate>
                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
