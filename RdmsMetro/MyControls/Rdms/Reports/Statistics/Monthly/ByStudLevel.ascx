<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ByStudLevel.ascx.vb" Inherits="Rdms_Metro.MyControls.Rdms.Reports.Statistics.Monthly.ByStudLevel" %>
...
<asp:GridView ID="GridView1" runat="server" CssClass="table striped hovered" AutoGenerateColumns="false" Width="600px" ShowFooter="true" >
    <Columns>
            ...
            <asp:TemplateField HeaderText="Level Code" SortExpression="studLevelCode" Visible="false">
                <ItemTemplate>
                    <asp:Label ID="studLevelCode" runat="server" Text='<%# Bind("studLevelCode")%>'></asp:Label>
                </ItemTemplate>
                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
