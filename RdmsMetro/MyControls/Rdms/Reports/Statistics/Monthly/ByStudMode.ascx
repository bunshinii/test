<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ByStudMode.ascx.vb" Inherits="Rdms_Metro.MyControls.Rdms.Reports.Statistics.Monthly.ByStudMode" %>
...
<asp:GridView ID="GridView1" runat="server" CssClass="table striped hovered" AutoGenerateColumns="false" Width="600px" ShowFooter="true" >
    <Columns>
            ...
            <asp:TemplateField HeaderText="Mode Code" SortExpression="studModeCode" Visible="false">
                <ItemTemplate>
                    <asp:Label ID="studModeCode" runat="server" Text='<%# Bind("studModeCode")%>'></asp:Label>
                </ItemTemplate>
                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
