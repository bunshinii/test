<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ByUnit.ascx.vb" Inherits="Rdms_Metro.MyControls.Rdms.Reports.Statistics.Monthly.ByUnit" %>
...
<asp:GridView ID="GridView1" runat="server" CssClass="table striped hovered" AutoGenerateColumns="false" Width="600px" ShowFooter="true" >
    <Columns>
            ...
            <asp:TemplateField HeaderText="Unit ID" SortExpression="unitId" Visible="false">
                <ItemTemplate>
