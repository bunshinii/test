...
#Region "Public Properties"
        ...
        Public Property ShowGenerateButton As Boolean
            Get
...
#Region "Fill Data"
        ...
        Private Sub FillStatsOption()
            ...
            chkCustom.Checked = MyRequest.GetChkCustomPatronId
...
#Region "Generate Query Strings"
        ...
        Public Function GenerateQueryString() As String
            ...
            'Basic
            Dim MyDate As Date = String.Format("{0}-{1}-{2}", "01", "01", ddYear.SelectedValue)
...
#Region "Generate Message"
        ...
        Private Function GenerateMessage() As String
            ...
            Select Case ddListType.SelectedValue
                Case "Individual"
                    If Not String.IsNullOrEmpty(TheDate) Then ReturnValue = String.Format("Reference Desk sessions on {0} by {1}", Format(CDate(TheDate), "yyyy"), OfficerName)
                ...
                Case "Branch"
                    ...
                    If Not String.IsNullOrEmpty(TheDate) Then ReturnValue = String.Format("Reference Desk sessions on {0} in {1}", Format(CDate(TheDate), "yyyy"), ddBranch.SelectedItem.Text)
                ...
                Case "Satellite"
                    ...
                    If Not String.IsNullOrEmpty(TheDate) Then ReturnValue = String.Format("Reference Desk sessions on {0} in {1}", Format(CDate(TheDate), "yyyy"), ddSatellite.SelectedItem.Text)
                ...
                Case "Department"
                    ...
                    If Not String.IsNullOrEmpty(TheDate) Then ReturnValue = String.Format("Reference Desk sessions on {0} in {1}", Format(CDate(TheDate), "yyyy"), ddDepartment.SelectedItem.Text)
                ...
                Case "Division"
                    ...
                    If Not String.IsNullOrEmpty(TheDate) Then ReturnValue = String.Format("Reference Desk sessions on {0} in {1}", Format(CDate(TheDate), "yyyy"), ddDivision.SelectedItem.Text)
                ...
                Case "Unit"
                    ...
                    If Not String.IsNullOrEmpty(TheDate) Then ReturnValue = String.Format("Reference Desk sessions on {0} in {1}", Format(CDate(TheDate), "yyyy"), ddUnit.SelectedItem.Text)
