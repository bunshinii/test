<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="Container.ascx.vb" Inherits="Rdms_Metro.MyControls.Rdms.Tables.Branch.Container" %>
...
<table class="table hovered">
    ...
    <tr>
        ...
        <th class="fullname text-left">Branch Name</th>
