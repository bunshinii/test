...
#Region "User Functions"
        ...
        Private Function SaveScript() As Boolean
            ...
            Dim IsBranchCodeExisted As Boolean = NasLib.Database.MySql.Provider.Table.OfficeBranch.IsInitialExistedNotSelf(lblCode.Text, txtCode.Text, ProvidersConnectionString)
            ...
            NasLib.Database.MySql.Provider.Table.OfficeBranch.BranchInitial(BranchId, ProvidersConnectionString) = TheCode_.ToLower
            NasLib.Database.MySql.Provider.Table.OfficeBranch.Branch(BranchId, ProvidersConnectionString) = txtName.Text
        ...
        Private Sub DeleteScript()
            ...
            NasLib.Database.MySql.Provider.Table.OfficeBranch.BranchDisable(BranchId, ProvidersConnectionString)
        End Sub
