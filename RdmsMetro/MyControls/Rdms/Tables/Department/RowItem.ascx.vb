...
#Region "User Functions"
        ...
        Private Function SaveScript() As Boolean
            ...
            Dim IsDepartmentCodeExisted As Boolean = NasLib.Database.MySql.Provider.Table.OfficeDepartment.IsInitialExistedNotSelf(lblCode.Text, txtCode.Text, ProvidersConnectionString)
            ...
            Dim DepartmentId_ As Integer = DepartmentId

            Dim TheCode_ As String = txtCode.Text.Replace(" ", "-").Replace(",", "").Trim
            NasLib.Database.MySql.Provider.Table.OfficeDepartment.Initial(DepartmentId_, ProvidersConnectionString) = TheCode_.ToLower
            NasLib.Database.MySql.Provider.Table.OfficeDepartment.Department(DepartmentId_, ProvidersConnectionString) = txtName.Text
        ...
        Private Sub DeleteScript()
            ...
            NasLib.Database.MySql.Provider.Table.OfficeDepartment.IsDisabled(DepartmentId, ProvidersConnectionString) = True
        End Sub
