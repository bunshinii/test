...
#Region "Public Properties"
        ...
        Public Property DivisionidId As Integer
            Get
                Return gDeptId.Text
            End Get
            Set(value As Integer)
...
#Region "User Functions"
        ...
        Private Function SaveScript() As Boolean
            ...
            Dim IsDivisionCodeExisted As Boolean = NasLib.Database.MySql.Provider.Table.OfficeDivision.IsInitialExistedNotSelf(lblCode.Text, txtCode.Text, ProvidersConnectionString)
            ...
            Dim DivisionId_ As Integer = DivisionidId

            Dim TheCode_ As String = txtCode.Text.Replace(" ", "-").Replace(",", "").Trim
            NasLib.Database.MySql.Provider.Table.OfficeDivision.Initial(DivisionId_, ProvidersConnectionString) = TheCode_.ToLower
            NasLib.Database.MySql.Provider.Table.OfficeDivision.Division(DivisionId_, ProvidersConnectionString) = txtName.Text
        ...
        Private Sub DeleteScript()
            ...
            NasLib.Database.MySql.Provider.Table.OfficeDivision.IsDisabled(DivisionidId, ProvidersConnectionString) = True
        End Sub
