<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="Container.ascx.vb" Inherits="Rdms_Metro.MyControls.Rdms.Tables.Satellite.Container" %>
...
<table class="table hovered">
    ...
    <tr>
        ...
        <th class="fullname text-left">Satellite Name</th>
