...
#Region "User Functions"
        ...
        Private Sub SaveScript()
            ...
            Dim IsSatelliteCodeExisted As Boolean = NasLib.Database.MySql.Provider.Table.OfficeSatellite.IsExistedInitial(txtCode.Text, ProvidersConnectionString)
            ...
            NasLib.Database.MySql.Provider.Table.OfficeSatellite.SatelliteAdd(txtName.Text, txtCode.Text, BranchId, ProvidersConnectionString)
...
#Region "Functions"
        ...
        Private Sub LoadTableData()
            Dim MyFieldname As String() = {"id", "satellite", "initial"}

            Dim SatelliteTable As DataTable = NasLib.Database.MySql.Provider.Table.OfficeSatellite.GetSatellitesByBranchId(BranchId, MyFieldname, ProvidersConnectionString)

            Dim SatelliteCount As Integer = SatelliteTable.Rows.Count

            If SatelliteCount > 0 Then
                For i As Integer = 0 To SatelliteCount - 1
                    Dim MyControls As MyControls.Rdms.Tables.Satellite.RowItem = LoadControl("~\MyControls\Rdms\Tables\Satellite\RowItem.ascx")
                    MyControls.No = i + 1
                    MyControls.SatelliteId = SatelliteTable(i)("id")
                    MyControls.SatelliteName = SatelliteTable(i)("satellite")
                    MyControls.SatelliteCode = SatelliteTable(i)("initial")
