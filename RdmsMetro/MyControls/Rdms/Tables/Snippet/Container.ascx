<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="Container.ascx.vb" Inherits="Rdms_Metro.MyControls.Rdms.Tables.Snippet.Container" %>
...
<table class="table hovered">
    ...
    <tr>
        ...
        <th class="fullname text-left">Snippet Text</th>
        <th class="patronid text-left">Order</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>*</td>
            <td><asp:TextBox ID="txtSnippet" runat="server" Width="100%"></asp:TextBox></td>
            <td><asp:TextBox ID="txtOrder" runat="server" Width="100%"></asp:TextBox></td>
...
<asp:Panel ID="PanelDebug" runat="server"></asp:Panel>
