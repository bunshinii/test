<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="Container.ascx.vb" Inherits="Rdms_Metro.MyControls.Rdms.Tables.Unit.Container" %>
...
<table class="table hovered">
    ...
    <tr>
        ...
        <th class="fullname text-left">Unit Name</th>
