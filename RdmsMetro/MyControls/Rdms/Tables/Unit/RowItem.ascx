<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="RowItem.ascx.vb" Inherits="Rdms_Metro.MyControls.Rdms.Tables.Unit.RowItem" %>
...
<asp:Panel ID="PanelDebug" runat="server" Visible="false">
    <asp:Label ID="gDivId" runat="server" Text="Label"></asp:Label>
</asp:Panel>
