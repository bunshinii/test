...
#Region "User Functions"
        ...
        Private Function SaveScript() As Boolean
            ...
            Dim IsUnitCodeExisted As Boolean = NasLib.Database.MySql.Provider.Table.OfficeUnit.IsInitialExistedNotSelf(lblCode.Text, txtCode.Text, ProvidersConnectionString)
            ...
            Dim UnitId_ As Integer = UnitId

            Dim TheCode_ As String = txtCode.Text.Replace(" ", "-").Replace(",", "").Trim
            NasLib.Database.MySql.Provider.Table.OfficeUnit.Initial(UnitId_, ProvidersConnectionString) = TheCode_.ToLower
            NasLib.Database.MySql.Provider.Table.OfficeUnit.Unit(UnitId_, ProvidersConnectionString) = txtName.Text
        ...
        Private Sub DeleteScript()
            ...
            NasLib.Database.MySql.Provider.Table.OfficeUnit.IsDisabled(UnitId, ProvidersConnectionString) = True
        End Sub
