...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        lblDate.Text = MyRequest.GetDate
        lblSatellite.Text = Table.OfficeSatellite.Satellite(SatelliteInitial, ProvidersConnectionString)

        Dim MyQueryString As String = NasLib.Functions.Web.QueryString.GetCurrentQueryString()
        SearchInternal1.VirtualPathRedirect = "~/Pages/Admin/DutyAdd.aspx"
        SearchInternal1.QueryString = MyQueryString
    End Sub
