<%@ Page Title="Manage Division" Language="vb" AutoEventWireup="false" MasterPageFile="~/Masters/MetroUIBox.Master" CodeBehind="Division.aspx.vb" Inherits="Rdms_Metro.Division" %>
<%@ Register Src="~/MyControls/MetroUI/Buttons/Breadcrumbs/Breadcrumb.ascx" TagName="Breadcrumb" TagPrefix="nas" %>
<%@ Register Src="~/MyControls/Rdms/Tables/Division/Container.ascx" TagPrefix="nas" TagName="DivisionTable" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <table>
            ...
            <tr>
                ...
                <td class="bg-darkBlue fg-white">
                    <asp:DropDownList ID="ddDepartment" runat="server" Width="300px"></asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td class="bg-darkBlue fg-white">
    ...
    <div class="nastable">
        <nas:DivisionTable runat="server" id="DivisionTable1" />
    </div>
