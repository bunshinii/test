...
#Region "Timer Message"
    ...
    Private Sub DisplayMessage(MessageCode As Integer)
        ...
        Select Case MessageCode
            Case 1
                lblMessage.Text = String.Format("Session recorded successfully")
                BackgroundColor = Drawing.Color.Green
            Case 2
                lblMessage.Text = String.Format("The session has been recorded as KIV, Please review it later.")
                BackgroundColor = Drawing.Color.DarkBlue
            Case 3
                lblMessage.Text = String.Format("Session has been updated successfully")
                BackgroundColor = Drawing.Color.Green
            Case 4
                lblMessage.Text = String.Format("The session has been updated to KIV status, Please review it later.")
                BackgroundColor = Drawing.Color.DarkBlue
...
#Region "Functions"
    ...
    Protected Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        Response.Redirect("~/Pages/User/PatronSearch.aspx", True)
    End Sub
